                    ...
                    <?php 
                        foreach($MOVIE_CAST_CREW['cast'] as $cast){
                            ...
                            if($cast['profile_path']){
                                echo '<a href="' . $GLOBALS["apppath"] . 'person/' . $cast['id'] . '"><img src="https://image.tmdb.org/t/p/w66_and_h66_face' . $cast['profile_path'] . '"></a>';
                            }
                            else{
                    ...
                    <?php 
                        foreach($MOVIE_CAST_CREW['crew'] as $crew){
                            ...
                            if($crew['profile_path']){
                                echo '<a href="' . $GLOBALS["apppath"] . 'person/' . $crew['id'] . '"><img src="https://image.tmdb.org/t/p/w66_and_h66_face' . $crew['profile_path'] . '"></a>';
                            }
                            else{
                                echo '<a><img src="../../images/person.svg" width=66 height=66 style="background-color: lightgrey;"></a>';
                            }
