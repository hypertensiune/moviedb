    ...
    <div id="container">
        <div id="wrapper">
            <div id="c1">
                ...
                <div id="facts">
                    <div id="social-media">
                        <a <?php if($PERSON_EIDS['facebook_id']) echo "href='https://www.facebook.com/" . $PERSON_EIDS['facebook_id'] . "'" ?>><i class="fa-brands fa-square-facebook"></i></a>
                        <a <?php if($PERSON_EIDS['twitter_id']) echo "href='https://twitter.com/" . $PERSON_EIDS['twitter_id'] . "'" ?>><i class="fa-brands fa-twitter"></i></a>
                        <a <?php if($PERSON_EIDS['instagram_id']) echo "href='https://www.instagram.com/" . $PERSON_EIDS['instagram_id'] . "'" ?>><i class="fa-brands fa-instagram"></i></a>
                    </div>
